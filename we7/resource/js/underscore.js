...
(function() {
    ...
    function e(n, t) {
        var r = S.length,
            e = n.constructor,
            u = d.isFunction(e) && e.prototype || i,
            o = "constructor";
    ...
    d.each = d.forEach = function(n, t, r) {
        t = g(t, r);
        var e, u;
        if (_(n)) for (e = 0, u = n.length; e < u; e++) t(n[e], e, n);
        else {
            var i = d.keys(n);
        ...
        var e, u, i = -1 / 0,
            o = -1 / 0;
        if (null == t && null != n) for (var a = 0, c = (n = _(n) ? n : d.values(n)).length; a < c; a++)(e = n[a]) > i && (i = e);
        else t = m(t, r), d.each(n, function(n, r, e) {
        ...
        for (var t, r = _(n) ? n : d.values(n), e = r.length, u = Array(e), i = 0; i < e; i++)(t = d.random(0, i)) !== i && (u[i] = u[t]), u[t] = r[i];
        return u
    ...
    d.flatten = function(n, t) {
        ...
        else if (r && u) return e = d.sortedIndex(n, t), n[e] === t ? e : -1;
    ...
    d.bind = function(n, t) {
        ...
        return function() {
            ...
            a || !1 !== r.leading || (a = l);
            var f = t - (l - a);
            return e = this, u = arguments, f <= 0 || f > t ? (o && (clearTimeout(o), o = null), a = l, i = n.apply(e, u), o || (e = u = null)) : o || !1 === r.trailing || (o = setTimeout(c, f)), i
        }
    }, d.debounce = function(n, t, r) {
        var e, u, i, o, a, c = function c() {
            var l = d.now() - o;
            l < t && l >= 0 ? e = setTimeout(c, t - l) : (e = null, r || (a = n.apply(i, u), e || (i = u = null)))
        };
        return function() {
    ...
    d.keys = function(n) {
        ...
        var e, u, i = {}, o = n;
        if (null == o) return i;
        d.isFunction(t) ? (u = d.allKeys(o), e = g(t, r)) : (u = A(arguments, !1, !1, 1), e = function(n, t, r) {
            return t in r
        }, o = Object(o));
    ...
    d.template = function(n, t, r) {
        ...
        var e = RegExp([(t.escape || B).source, (t.interpolate || B).source, (t.evaluate || B).source].join("|") + "|$", "g"),
            u = 0,
            i = "__p+='";
    ...
    d.mixin = function(n) {
        ...
        d.prototype[n] = function() {
            var r = this._wrapped;
            return t.apply(r, arguments), "shift" !== n && "splice" !== n || 0 !== r.length || delete r[0], K(this, r)
        }
