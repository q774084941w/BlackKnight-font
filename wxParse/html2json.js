    ...
    html2json: function(e, a) {
        ...
        return d(e, {
            start: function(e, t, r) {
                ...
                if (0 === o.length ? (s.index = g.toString(), g += 1) : (void 0 === (x = o[0]).nodes && (x.nodes = []), s.index = x.index + "." + x.nodes.length), c[e] ? s.tagType = "block" : u[e] ? s.tagType = "inline" : p[e] && (s.tagType = "closeSelf"), 0 !== t.length && (s.attr = t.reduce(function(e, t) {
                    var r = t.name,
                        n = t.value;
                    return "class" == r && (console.dir(n), s.classStr = n), "style" == r && (console.dir(n), s.styleStr = n), n.match(/ /) && (n = n.split(" ")), e[r] ? Array.isArray(e[r]) ? e[r].push(n) : e[r] = [e[r], n] : e[r] = n, e
                }, {})), "img" === s.tag) {
                    s.imgIndex = i.images.length;
                    var d = s.attr.src;
                    "" == d[0] && d.splice(0, 1), d = l.urlToHttpUrl(d, n), s.attr.src = d, s.from = a, i.images.push(s), i.imageUrls.push(d)
                }
                if ("font" === s.tag) {
                ...
                var t = o.shift();
                if (t.tag !== e && console.error("invalid state: mismatch end tag"), "video" === t.tag && i.source && (t.attr.src = i.source, delete i.source), 0 === o.length) i.nodes.push(t);
                else {
                    var r = o[0];
            ...
            chars: function(e) {
                ...
                if (0 === o.length) t.index = g.toString(), g += 1, i.nodes.push(t);
                else {
                    var r = o[0];
