...
Page({
    ...
    onLoad: function(e) {
        ...
        o.request({
            ...
            success: function(e) {
                var a = e.status,
                    i = JSON.parse(e.diy);
                console.log(i), a && (wx.setNavigationBarTitle({
        ...
        if (o.request({
            ...
            success: function(e) {
                console.log("============", e), n[0] = i._weekArr, n[1] = e.data, t.setData({
                    timeArr: n
                })
            }
        }), e.tags) {
    ...
    GetAddresss: function() {
        ...
        wx.chooseLocation({
            success: function(i) {
                e.setData({
                    hasLocation: !0,
                    detail_infoss: i.address + i.name,
                    wds: i.latitude,
                    jds: i.longitude
                }), o.request({
                    url: r.
                    ...
                    data: {
                        myaddsjd: a,
                        myaddswd: t,
                        mudaddswd: i.latitude,
                        mudaddsjd: i.longitude,
                        bid: wx.getStorageSync("bid")
                    },
                    success: function(t) {
    ...
    countPrice: function() {
        var e = this,
            t = Number(e.data.price) + Number(e.data.timeprice) + Number(e.data.reward) + Number(e.data.ins) + Number(e.data.stepper.stepper) - Number(e.data.integral);
        t < e.data.full_money ? (t = t, e.setData({
            coupon: 0
        })) : t = Number(e.data.price) + Number(e.data.timeprice) + Number(e.data.reward) + Number(e.data.ins) + Number(e.data.stepper.stepper) - Number(e.data.coupon) - Number(e.data.integral), t < .01 && (t = 0), e.setData({
    ...
    formSubmit: function(e) {
        ...
        var t = this,
            ...
            i = t.data.yinpin;
        console.log(e.detail.value.mytimes), ("" != e.detail.value.goodsname || "" != a || "" != i) && !0 === t.data.isReadProtocol ? "" != e.detail.value.mytimes && "-" != e.detail.value.mytimes ? (e.detail.value.xphoto = a, e.detail.value.yinpin = i, console.log("e.detail.value", e.detail.value), t.setData({
    ...
    clickAction: function(t) {
        var a, i = this,
            n = t.detail.index;
        switch (this.setData((a = {}, e(a, "actions[" + n + "].loading", !0), e(a, "actionType", n), e(a, "clickpay", !1), a)), n) {
            case 0:
    ...
    wechatPay: function() {
        var e = this,
            t = e.data.formData;
        console.log("表单数据=>", t), console.log("微信支付"), o.request({
            url: r.
            default.insertorder,
            data: {
                distype: t.distype,
                    ...
                    success: function(t) {
                        e.setData({
                            ...
                            success: function(a) {
                                e.setData({
                                    clickpay: !0
                                }), console.log("支付成功", a), e.data.useid && o.request({
                                    url: r.Coupon.status,
                                    data: {
                                        useid: e.data.useid
                                    },
