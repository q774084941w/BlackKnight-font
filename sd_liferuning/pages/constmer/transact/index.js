...
Page({
                            ...
                            d.request({
                                ...
                                success: function(t) {
                                    ...
                                    console.log(a), console.log("金额", t), e.setData({
                                        ...
                                        success: function(t) {
                                            e.setData({
                                                weight_price: t.data.data
                                            }), e.countPrice()
                                        }
                                    }), console.log(e.data.price, "-------------price"), e.countPrice()
                                }
                            })
                        }
                    })
    ...
    countPrice: function() {
        var e = this,
            t = Number(e.data.prices) + Number(e.data.stepper.stepper) + Number(e.data.reward) + Number(e.data.weight_price) - Number(e.data.integral);
        t < e.data.full_money ? (t = t, e.setData({
            coupon: 0
        })) : t = Number(e.data.prices) + Number(e.data.stepper.stepper) + Number(e.data.reward) - Number(e.data.coupon) + Number(e.data.weight_price) - Number(e.data.integral), t = t < .01 ? 0 : t, e.setData({
    ...
    formSubmit: function(e) {
        ...
        var t = this,
            ...
            i = t.data.yinpin;
        ("" != e.detail.value.goodsname || "" != a || "" != i) && e.detail.value.mudadds && "NaN" != e.detail.value.mytimes && !0 === t.data.isReadProtocol ? "" != e.detail.value.mytimes && "-" != e.detail.value.mytimes ? (console.log(a), console.log(i), e.detail.value.xphoto = a, e.detail.value.yinpin = i, console.log("e.detail.value", e.detail.value), t.setData({
    ...
    clickAction: function(t) {
        var a, i = this,
            r = t.detail.index;
        switch (this.setData((a = {}, e(a, "actions[" + r + "].loading", !0), e(a, "actionType", r), a)), r) {
            case 0:
    ...
    balancePay: function() {
        ...
        d.request({
            ...
            data: (t = {
                ...
                phone: a.data.phone
            }, e(t, "order_type", n), e(t, "old_order_no", i.old_order_no), e(t, "proxy_id", a.data.proxy_id ? a.data.proxy_id : 0), t),
            success: function(e) {
                1 == e.code && d.request({
                    url: o.order.pricePay,
                    method: "post",
                    data: {
                        uid: wx.getStorageSync("uid"),
                        order_no: e.data,
