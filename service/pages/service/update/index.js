...
Page({
  ...
  countPrice: function () {
    ...
    t < e.data.full_money ? (t = Number(e.data.price) + Number(e.data.stepper.stepper) + Number(e.data.reward) + Number(e.data.weight_price) - Number(e.data.integral), e.setData({
      coupon: 0
    })) : t = Number(e.data.price) + Number(e.data.stepper.stepper) + Number(e.data.reward) - Number(e.data.coupon) + Number(e.data.weight_price) - Number(e.data.integral), t = t < .01 ? 0 : t,t=t*0.8, e.setData({
  ...
  formSubmit: function (e) {
    ...
    var t = this,
      ...
      i = t.data.yinpin;
    ("" != e.detail.value.goodsname || "" != a || "" != i) && e.detail.value.username && e.detail.value.phone && e.detail.value.mudadds && e.detail.value.myadds && "NaN" != e.detail.value.mytimes && !0 === t.data.isReadProtocol ? (console.log(a), console.log(i), e.detail.value.xphoto = a, e.detail.value.yinpin = i,console.log("e.detail.value", e.detail.value), t.setData({
      formData: e.detail.value,
      formId: e.detail.formId
    }), t.balancePay()) : wx.showToast({
      title: "信息不完善，无法下单。"
    })
  },
